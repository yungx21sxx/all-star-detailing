			...
			<div class="service__columns  margin-block-end">
				<section>
					...
					<p class="service__text">
						<strong>Виниловая пленка</strong> - это идеальное решение для изменения цвета вашего автомобиля, обеспечивая ему защиту и стиль. Эта высококачественная пленка легко наносится и идеально облегает контуры авто, создавая гладкое и ровное покрытие.
					</p>
					<p class="service__text">
