...
<template>
	<v-card class="complex" itemscope itemtype="https://schema.org/Offer">
		...
		<ul class="complex__list" itemprop="itemOffered" itemscope itemtype="https://schema.org/Service">
			<li
				class="list-item"
		...
		<v-btn color="#f1aa34" class="complex__btn" :href="`/complex/${complex.id}`" itemprop="url">Подробнее</v-btn>
		<v-btn @click="openSubmitModal(complex.title)" color="#f1aa34" variant="tonal" class="mt-4">Записаться</v-btn>
	</v-card>
</template>
