...
import { c as consola, A, f, U } from './nuxi.f8a4d1b7.mjs';
import 'node:util';
import 'node:path';
import 'node:process';
import 'node:tty';
import '../chunks/satisfies.mjs';
import { f as findWorkspaceDir, r as readPackageJSON } from './nuxi.44a0b114.mjs';
import { fileURLToPath } from 'node:url';
import 'node:module';
import './nuxi.4d986127.mjs';
import { r as resolvePath$1 } from './nuxi.3d05c4d3.mjs';
import { w as withoutLeadingSlash, a as withTrailingSlash } from './nuxi.deb0a220.mjs';
import { f as normalizeWindowsPath, j as join, r as resolve, c as basename, b as relative, i as isAbsolute, d as dirname, n as normalize } from './nuxi.a100eb6a.mjs';
import { readdir } from 'node:fs/promises';
import nodeCrypto from 'node:crypto';
import { s as semver } from './nuxi.15c58622.mjs';
import { t as tryResolveModule$1, i as importModule } from './nuxi.34efa6e8.mjs';
...
async function tryResolveNuxt(rootDir) {
  for (const pkg of ["nuxt-nightly", "nuxt3", "nuxt", "nuxt-edge"]) {
    const path = await tryResolveModule$1(pkg, rootDir);
    if (path) {
      return path;
    }
  }
