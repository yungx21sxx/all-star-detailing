...
const packageManager = "pnpm@9.14.2";
const engines = {
	node: "^16.10.0 || >=18.0.0"
};
const nuxiPkg = {
...
export { A, U, a, colors as b, consola as c, defineCommand as d, box as e, f, getColor$1 as g, getDefaultExportFromCjs as h, isUnicodeSupported as i, runMain as j, main as m, nuxiPkg as n, runCommand as r };
