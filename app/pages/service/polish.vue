<script lang="ts" setup>
  ...
  useSeoMeta({
    ...
    description:
      'Профессиональная полировка кузова автомобиля. Верните своему автомобилю первозданный вид All Star Detailing. Востановительная и глубокая полировка: цена от 15 000 ₽',
...
<template>
  ...
  >
    ...
    <p class="text banner__text">
      Верните своему автомобилю первозданный вид в <strong>All Star Detailing</strong>
    </p>
  ...
  <div class="wrapper service__content">
    ...
    <div class="service__columns" style="gap: 24px">
      <div class="card">
        <h3 class="card__title">Востановительная полировка</h3>
        <div class="card__price">от 15 000 ₽</div>
        <div class="card__time">Выполним за 2 дня</div>
        <v-divider class="" />
        <div class="card__description">
          <ul class="card__list">
            ...
            <li class="list-item">
              <v-icon :icon="mdiCheckCircleOutline" color="#f1aa34" />
              <span
                >Аккуратно обработаем поверхность, сохраняя оригинальное покрытие в идеальном
                состоянии</span
              >
            </li>
          </ul>
      ...
      <div class="card">
        <h3 class="card__title">Глубокая полировка</h3>
        <div class="card__price">от 35 000 ₽</div>
        <div class="card__time">Выполним за 2 дня</div>
        <v-divider class="" />
        <div class="card__description">
          <ul class="card__list">
            ...
            <li class="list-item">
              <v-icon :icon="mdiCheckCircleOutline" color="#f1aa34" />
              <span
                >процедура возвращает автомобилю его роскошный вид, придавая глубокий и насыщенный
                цвет кузову</span
              >
            </li>
          </ul>
    ...
    <VintersectAnimation class="mt-8">
      <PriceTable
        ...
        title="Цены на полировку кузова"
      />
    </VintersectAnimation>
  </div>
