      ...
      <div class="hero__wrapper wrapper">
        <div class="hero__content">
          <div class="contact-block contact-block_desktop">
            ...
            <v-btn @click="openSubmitModal(null)" variant="flat" color="#f1aa34" class="banner__btn"
              >Записаться онлайн</v-btn
            >
          </div>
        </div>
      </div>
...
<script setup lang="ts">
  ...
  useSeoMeta({
    ...
    description:
      'Свяжитесь с нами для получения подробной информации о наших услугах и записи на детейлинг. Мы находимся в Санкт-Петербурге, пр. Энгельса, 27АБ.',
