<script setup lang="ts">
  ...
  useSeoMeta({
    ...
    description:
      '🚗Полный спектр детейлинг-услуг в Санкт-Петербурге по доступным ценам! Оклейка пленкой, ✨ полировка кузова, 🛡️ керамика, 🧼 химчистка салона. 🎁 При регистрации начислим – 1000 бонусов! После услуги возвращаем 5% на ваш бонусный счет.',
    ...
    script: [
      {
        ...
        innerHTML: JSON.stringify({
          ...
          description:
            'Профессиональный детейлинг центр в Санкт-Петербурге, предлагающий полный спектр услуг по уходу за автомобилем.',
          address: {
            '@type': 'PostalAddress',
...
<template>
  ...
  <div class="gallery block-end-margin block">
    <div class="wrapper">
